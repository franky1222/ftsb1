...
function c() {
    ...
    for (var i = 0; i < myArray.length - 1; i = i + 4) {
        ...
        var rectangleView = "<div id='" + rectangleId + "' class='line' x='" + x1 + "' y='" + x2 + "' style='left: " + x1 + "px;top:" + x2 + "px;width:" + x3 + "px;height:" + x4 + "px'><img draggable='false' class='change_size'><div class='glyphicon glyphicon-remove delete_line'></div></div>";
        $('.biaoDiv').append(rectangleView);
        isFirstMove = true;
        //console.log(rectangleId + "first")
